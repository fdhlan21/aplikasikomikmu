...
function HalamanDrama({navigation}) {
  return (
...
<View style={{flexDirection:'row', padding:10,  paddingLeft:95,}}>
<Text style={{color:colors.white, fontFamily:'Alata-Regular', fontSize:30,}}>Drama</Text>
</View>
