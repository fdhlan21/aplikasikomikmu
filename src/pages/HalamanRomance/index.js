...
function HalamanRomance({navigation}) {
  return (
...
<View style={{flexDirection:'row', padding:10,  paddingLeft:78,}}>
<Text style={{color:colors.white, fontFamily:'Alata-Regular', fontSize:30,}}>Romance</Text>
</View>
